...
public class SingUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        dbuser= FirebaseDatabase.getInstance().getReference("Users");  //We get the reference of our database
        ...
        ahsignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String id=   dbuser.push().getKey(); //it create a unique string inside a Users and we get the key

                Users users=new Users(email,password,id);

                //Now we use setvalue method to store the data in to firebase database

                assert id != null;
                dbuser.child(id).setValue(users); //but we store the users inside the id that is uniquqly generated

                Toast.makeText(SingUp.this, "User information Added", Toast.LENGTH_SHORT).show();
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                  ...
                                  //  FirebaseUser user = mAuth.getCurrentUser();
                                    Toast.makeText(SingUp.this, "Authentication Succes.",
